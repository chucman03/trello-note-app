...
import { addNotification, fetchInvitationsAPI, selectCurrentNotifications, updateBoardInvitationsAPI } from '~/redux/notifications/notificationsSlice'
...
function Notifications() {
  ...
  const handleClickNotificationIcon = (event) => {
    ...
    // chuyen thong bao ve binh thuong
  ...
  useEffect(() => {
    ...
    // tao 1 function xu ly khi nhan su kien realtime
    const onReceiveNewInvitation = (invitation) => {
      if (invitation.inviteeId === currentUser._id) {
        // them ban ghi invitation moi vao redux
        dispatch(addNotification(invitation))
        // cap nhat trang thai co thong bao
        setNewNotification(true)
      }
    }
      // lang nghe 1 su kien realtime ten la BE USER...
      ...
      <Tooltip title="Notifications">
        ...
        >
          <NotificationsNoneIcon sx={{
            color: newNotification? 'yellow' : 'grey'
          }} />
        </Badge>
      </Tooltip>
